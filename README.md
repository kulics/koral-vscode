...
2. 生成文件：`koral-language-support-0.0.10.vsix`
3. 安装命令：`code --install-extension "D:\\workspace\\koral-vscode\\koral-language-support-0.0.10.vsix" --force`
...
1. 修改 `package.json` 中的 `version`（例如 `0.0.9 -> 0.0.10`）。
